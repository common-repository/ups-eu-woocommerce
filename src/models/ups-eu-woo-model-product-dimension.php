...
new \UpsEuWoocommerce\Ups_Eu_Woo_Main_Autoloader('Ups_Eu_Woo_Model_Product_Dimension');

class Ups_Eu_Woo_Model_Product_Dimension extends entities\Ups_Eu_Woo_Product_Dimension_Entity implements Ups_Eu_Woo_Interfaces
{
    private $table_name = "";
    ...
    public function __construct()
    {
        parent::__construct();
        global $wpdb;
        $this->table_name = "{$wpdb->prefix}{$this->prefix_ups}product_dimension";
