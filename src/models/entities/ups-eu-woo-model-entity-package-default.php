...
new \UpsEuWoocommerce\Ups_Eu_Woo_Main_Autoloader('Ups_Eu_Woo_Package_Default_Entity');

class Ups_Eu_Woo_Package_Default_Entity extends \UpsEuWoocommerce\models\Ups_Eu_Woo_Data_Base
{
    /* List colum name in table [package_default] database */
    ...
    public $col_package_item = "package_item";
    /* list key */
}
